...
{
    XCONFD_YANG_TREE_LIST_FOREACH(yt, du_module_log_yt)
    {
        auto du_module_log = std::make_shared<DuModuleLog>();
        read_grp_du_module_log(du_module_log_yt, *du_module_log);
...
{
    XCONFD_YANG_TREE_LIST_FOREACH(yt, ngp_module_log_yt)
    {
