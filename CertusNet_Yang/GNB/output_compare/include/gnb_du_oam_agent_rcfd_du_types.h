/*!********************************************************************************************************************
 * file        gnb_du_oam_agent_rcfd_du_types.h
 *
 * brief       This header file contains implementation of OAM Agent RConfD DU
 *********************************************************************************************************************/
...
void read_grp_ip_addr(XCONFD_YANGTREE_T* yt, IpAddr& ip_addr)
{
   ...
   xconfd_get_optional(ip_addr.ipv4_addr, std::string, string, "ipv4-addr", yt);
   xconfd_get_optional(ip_addr.ipv6_addr, std::string, string, "ipv6-addr", yt);
}
...
{
   read_grp_ip_addr(yt, ip_addr_port.ip_addr);
...
#endif /*__GNB_DU_OAM_AGENT_RCFD_DU_TYPES_H__*/
